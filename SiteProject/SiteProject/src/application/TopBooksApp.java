...
public class TopBooksApp extends Application {
    ...
    private List<Book> loadBooks() {
        ...
        String[] summaries = {
                ...
                "Dans cette romance, nous retrouvons Perséphone Déesse du printemps qui n'a malheureusement aucun pouvoir et vit dans le monde des humains et Hadès Dieu des enfers. Après leur rencontre elle se retrouve liés a"
